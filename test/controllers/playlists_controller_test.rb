...
class PlaylistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create playlist" do
    assert_difference('Playlist.count') do
      post playlists_url, params: { playlist: { playlistname: @playlist.playlistname, song_id: @playlist.song_id, user_id: @playlist.user_id } }
    end
  ...
  test "should update playlist" do
    patch playlist_url(@playlist), params: { playlist: { playlistname: @playlist.playlistname, song_id: @playlist.song_id, user_id: @playlist.user_id } }
